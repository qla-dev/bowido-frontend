...
const roleBadgeClasses: Record<RoleType, string> = {
  ...
  [RoleType.ADMIN_SERVICE]: 'bg-rose-50 text-rose-700 border-rose-200',
  [RoleType.ADMIN_WAREHOUSE]: 'bg-cyan-50 text-cyan-700 border-cyan-200',
  [RoleType.FINANCE_ADMINISTRATION]: 'bg-blue-50 text-blue-700 border-blue-200',
