...
const copyByLanguage = {
  en: {
    ...
    pickupDateLabel: 'Other date',
    pickupDatePlaceholder: 'Select date',
  ...
  nl: {
    ...
    pickupDateLabel: 'Andere datum',
    pickupDatePlaceholder: 'Datum selecteren',
  ...
  bs: {
    ...
    subtitle: 'Prijavite palete bez QR pločice i označite ih kao spremne za preuzimanje.',
    ...
    locationPlaceholder: 'npr. rampa, vanjsko skladište, zadnji ulaz...',
    pickupLabel: 'Dostupno za preuzimanje',
    directPickup: 'Odmah preuzeti',
    pickupDateLabel: 'Drugi datum',
    pickupDatePlaceholder: 'Odaberite datum',
    ...
    reportButtonText: 'Spremno za povrat, ali bez QR pločice.',
