...
const statusLabels: Record<AppLanguage, Record<string, string>> = {
  ...
  nl: {
    ...
    "Bowido NL": "Bowido NL",
    "Bowido BiH": "Bowido BiH",
    "Za preuzimanje kod klijenta": "Voor retour",
    "Ophalen klant": "Voor retour",
    Service: "Service",
    Nepoznato: "Onbekend",
...
export const translations = {
  en: {
    ...
    noQrPallets: "Pallets without a QR code",
    sidebarNoQrPallets: "Pallets without a QR code",
    ...
    noQrReportImage: "Pallets without QR codes",
    deliveryReportImage: "Delivery report",
    ...
    repairStatusChange: "Repair Status",
    markedForRepair: "Marked for Repair",
    unmarkedForRepair: "Removed from Repair",
    ...
    ghostReport: "Pallets without QR codes",
    ...
    ghostReportTitle: "Pallets without QR code",
    ...
    openGhostEntries: "Open reports for pallets without QR codes",
    reviewAndPair: "Review and Pair",
    reviewAndPairDescription:
      "Each reported pallet without a QR code stays here until a new QR code is assigned.",
    searchReports: "Search reports",
    unknownClient: "Unknown client",
    noAdditionalNote: "No additional note for this report.",
    reviewAndPairAction: "Review and pair",
    newQrCode: "New QR Code",
    noOpenGhostReports: "No open reports for pallets without QR codes",
    ...
    unlabeledUnitsGhosts: "Unlabeled units (without QR codes)",
    ...
    generateAndExportQr: "Generate and export QR codes",
    qrZipExportHint: "A ZIP containing one QR label per pallet will download after creation.",
    qrPdfExportHint: "A print-ready PDF of all QR labels will download after creation.",
    creatingPallets: "Creating...",
    palletCreateFailed: "Unable to create pallets",
    palletsCreatedTitle: "Pallets created",
    palletsCreatedConfirmation: "The new pallets are set to Unknown and are not assigned to a customer.",
    palletsCreatedAndExported: "The new pallets are set to Unknown and are not assigned to a customer. Your QR export has downloaded.",
    qrMultiExportHint: "Select one or more formats. Image formats download as separate ZIP files; PDF downloads as a print-ready document.",
    qrExport: "QR export",
    qrExportTitle: "Export QR codes",
    qrExportDescription: "Export QR labels for every pallet currently matching the table filters and search.",
    qrExportPalletCount: "Pallets to export",
    qrExportLoading: "Loading QR export data, please wait",
    qrExportModeCurrent: "Current list",
    qrExportModeRange: "QR range",
    qrExportModeSingle: "One pallet",
    qrExportCurrentHint: "Exports every QR-enabled pallet matching the current table search and filters.",
    qrExportChoosePallet: "Select a pallet",
    qrExportSearchPallet: "Search pallets...",
    exporting: "Exporting...",
    ...
    markForRepair: "Mark the pallet for repair",
    unmarkForRepair: "Unmark the pallet for repair",
    palletScanned: "Pallet scanned",
    addPalletPhoto: "Add pallet photo",
    skipPhoto: "Skip photo",
    savePhoto: "Save photo",
    continueAction: "Continue",
    takePhoto: "Take photo",
    choosePhotos: "Choose photos",
    photoDatabaseLimit: "Up to 10 photos are saved in the database when you send this report.",
    removePhoto: "Remove photo",
    zoomOut: "Zoom out",
    zoomIn: "Zoom in",
    previousPhoto: "Previous photo",
    nextPhoto: "Next photo",
    qrValueTooLong: "QR value too long",
    invoiceActive: "Active",
    palletStatusSaveBeforeLocationError: "The pallet status could not be saved. Try again before saving the delivery location.",
    knowledgeAdminGlobalSettingsTitle: "Global settings",
    knowledgeAdminGlobalSettingsDescription: "Configure status behavior, pricing, and grace periods.",
    knowledgeAdminDebtTitle: "Debt management",
    knowledgeAdminDebtDescription: "Overview of client debts and pallet stay durations.",
    knowledgeAdminExportTitle: "Exporting data",
    knowledgeAdminExportDescription: "How to export fleet reports to PDF or Excel.",
    knowledgeDriverBulkTitle: "Bulk scanning",
    knowledgeDriverBulkDescription: "Scan multiple pallets at once for faster delivery.",
    knowledgeDriverClientTitle: "Choosing a client",
    knowledgeDriverClientDescription: "The system automatically offers client search for the Bij de klant status.",
    knowledgeDriverReturnTitle: "Voor retour",
    knowledgeDriverReturnDescription: "How to mark pallets that are ready for collection.",
    knowledgeWarehouseFlowTitle: "Inbound and outbound",
    knowledgeWarehouseFlowDescription: "Recording pallets entering and leaving the BiH and NL warehouses.",
    knowledgeWarehouseDamageTitle: "Reporting damage",
    knowledgeWarehouseDamageDescription: "A photo and damage description are required before sending a pallet for service.",
    knowledgeClientGraceTitle: "Grace period",
    knowledgeClientGraceDescription: "How the 14-day free period works.",
  },
  nl: {
    dashboard: "Dashboard",
    pallets: "Bokken",
    ...
    sidebarNoQrPallets: "Bokken zonder QR-code",
    clients: "Klant Admin",
    ...
    noQrReportImage: "Pallets zonder QR-codes",
    deliveryReportImage: "Leveringsrapport",
    ...
    repairStatusChange: "Reparatiestatus",
    markedForRepair: "Gemarkeerd voor reparatie",
    unmarkedForRepair: "Verwijderd uit reparatie",
    ...
    overdueWarningText:
      "De respijtperiode van 14 dagen is voor meerdere eenheden overschreden.",
    ...
    ghostReport: "Bokken zonder QR-code",
    reportNow: "Nu melden",
    ...
    gracePeriodDaysLabel: "Respijtperiode (dagen)",
    ...
    calendarSeedGraceReview:
      "Controleer lokale uitzonderingen voor de respijtperiode vóór de weekendafsluiting.",
    ...
    ghostReportTitle: "Melding bokken zonder QR-code",
    ghostReportSubtitle:
    ...
    openGhostEntries: "Open meldingen voor bokken zonder QR-code",
    reviewAndPair: "Controleren en koppelen",
    reviewAndPairDescription:
      "Elke gemelde bok zonder QR-code blijft hier totdat een nieuwe QR-code wordt toegewezen.",
    ...
    noOpenGhostReports: "Geen open meldingen voor bokken zonder QR-code",
    withoutQr: "Zonder QR",
    pair: "Koppelen",
    ...
    unitsInGrace: "Eenheden in respijtperiode",
    ...
    unlabeledUnitsGhosts: "Eenheden zonder label (zonder QR-code)",
    ...
    generateAndExportQr: "QR-codes genereren en exporteren",
    qrZipExportHint: "Na het aanmaken wordt een ZIP met één QR-label per bok gedownload.",
    qrPdfExportHint: "Na het aanmaken wordt een printklare PDF met alle QR-labels gedownload.",
    creatingPallets: "Bokken aanmaken...",
    palletCreateFailed: "Bokken kunnen niet worden aangemaakt",
    palletsCreatedTitle: "Bokken aangemaakt",
    palletsCreatedConfirmation: "De nieuwe bokken hebben de status Onbekend en zijn niet aan een klant toegewezen.",
    palletsCreatedAndExported: "De nieuwe bokken hebben de status Onbekend en zijn niet aan een klant toegewezen. De QR-export is gedownload.",
    qrMultiExportHint: "Kies één of meer formaten. Afbeeldingen worden als afzonderlijke ZIP-bestanden gedownload; PDF is een printklaar document.",
    qrExport: "QR-export",
    qrExportTitle: "QR-codes exporteren",
    qrExportDescription: "Exporteer QR-labels voor alle bokken die overeenkomen met de huidige tabelzoekopdracht en filters.",
    qrExportPalletCount: "Te exporteren bokken",
    qrExportLoading: "QR-exportgegevens worden geladen, een moment geduld",
    qrExportModeCurrent: "Huidige lijst",
    qrExportModeRange: "QR-bereik",
    qrExportModeSingle: "Eén bok",
    qrExportCurrentHint: "Exporteert alle bokken met QR-code die overeenkomen met de huidige tabelzoekopdracht en filters.",
    qrExportChoosePallet: "Selecteer een bok",
    qrExportSearchPallet: "Zoek bokken...",
    ...
    inUse: "In gebruik",
    forClientPickup: "Voor retour",
    palletsAtClient: "Bokken bij de klant",
    ...
    open: "Openen",
    forRepair: "Voor reparatie",
    markForRepair: "Markeer de bok voor reparatie",
    unmarkForRepair: "Verwijder de bok uit reparatie",
    palletScanned: "Bok gescand",
    addPalletPhoto: "Bokfoto toevoegen",
    skipPhoto: "Foto overslaan",
    savePhoto: "Foto opslaan",
    continueAction: "Doorgaan",
    takePhoto: "Foto maken",
    choosePhotos: "Foto's kiezen",
    photoDatabaseLimit: "Bij het versturen van dit rapport worden maximaal 10 foto's in de database opgeslagen.",
    removePhoto: "Foto verwijderen",
    zoomOut: "Uitzoomen",
    zoomIn: "Inzoomen",
    previousPhoto: "Vorige foto",
    nextPhoto: "Volgende foto",
    qrValueTooLong: "QR-waarde is te lang",
    invoiceActive: "Actief",
    palletStatusSaveBeforeLocationError: "De bokstatus kon niet worden opgeslagen. Probeer het opnieuw voordat u de afleverlocatie opslaat.",
    knowledgeAdminGlobalSettingsTitle: "Algemene instellingen",
    knowledgeAdminGlobalSettingsDescription: "Configureer statusgedrag, tarieven en respijtperiodes.",
    knowledgeAdminDebtTitle: "Schuldbeheer",
    knowledgeAdminDebtDescription: "Overzicht van klantschulden en verblijfsduur van bokken.",
    knowledgeAdminExportTitle: "Gegevens exporteren",
    knowledgeAdminExportDescription: "Bokkenrapporten exporteren naar PDF of Excel.",
    knowledgeDriverBulkTitle: "Bulkscannen",
    knowledgeDriverBulkDescription: "Scan meerdere bokken tegelijk voor een snellere levering.",
    knowledgeDriverClientTitle: "Een klant kiezen",
    knowledgeDriverClientDescription: "Het systeem biedt automatisch klantzoeken aan bij de status Bij de klant.",
    knowledgeDriverReturnTitle: "Voor retour",
    knowledgeDriverReturnDescription: "Bokken markeren die klaarstaan om opgehaald te worden.",
    knowledgeWarehouseFlowTitle: "Inkomend en uitgaand",
    knowledgeWarehouseFlowDescription: "Registratie van bokken die de magazijnen in BiH en NL binnenkomen en verlaten.",
    knowledgeWarehouseDamageTitle: "Schade melden",
    knowledgeWarehouseDamageDescription: "Een foto en schadeomschrijving zijn verplicht voordat een bok naar de service gaat.",
    knowledgeClientGraceTitle: "Respijtperiode",
    knowledgeClientGraceDescription: "Zo werkt de gratis periode van 14 dagen.",
  },
  bs: {
    dashboard: "Kontrolna tabla",
    adminPalletOverview: "Praćenje paleta",
    noQrPallets: "Palete bez QR koda",
    sidebarNoQrPallets: "Palete bez QR koda",
    ...
    noQrReportImage: "Palete bez QR kodova",
    deliveryReportImage: "Izvještaj o isporuci",
    ...
    repairStatusChange: "Status servisa",
    markedForRepair: "Označeno za servis",
    unmarkedForRepair: "Uklonjeno sa servisa",
    ...
    ghostReport: "Palete bez QR koda",
    ...
    gracePeriodDaysLabel: "Period tolerancije (dani)",
    ...
    calendarSeedGraceReview:
      "Pregledajte lokalne izuzetke perioda tolerancije prije vikend zatvaranja.",
    ...
    termLabel: "Rok",
    unitsLabel: "jedinica",
    gracePeriodLabel: "Period tolerancije",
    ...
    ghostReportTitle: "Prijava paleta bez QR koda",
    ...
    openGhostEntries: "Otvorene prijave paleta bez QR koda",
    reviewAndPair: "Provjera i uparivanje",
    reviewAndPairDescription:
      "Svaka prijavljena paleta bez QR koda ostaje ovdje dok joj se ne dodijeli novi QR kod.",
    ...
    noOpenGhostReports: "Nema otvorenih prijava paleta bez QR koda",
    withoutQr: "Bez QR-a",
    pair: "Upari",
    ...
    unitsInGrace: "Jedinice u periodu tolerancije",
    ...
    unlabeledUnitsGhosts: "Jedinice bez oznake (bez QR koda)",
    ...
    generateAndExportQr: "Generiši i izvezi QR kodove",
    qrZipExportHint: "Nakon kreiranja preuzet će se ZIP s jednom QR oznakom za svaku paletu.",
    qrPdfExportHint: "Nakon kreiranja preuzet će se PDF spreman za štampu sa svim QR oznakama.",
    creatingPallets: "Kreiranje...",
    palletCreateFailed: "Kreiranje paleta nije uspjelo",
    palletsCreatedTitle: "Palete su kreirane",
    palletsCreatedConfirmation: "Nove palete imaju status Nepoznato i nisu dodijeljene klijentu.",
    palletsCreatedAndExported: "Nove palete imaju status Nepoznato i nisu dodijeljene klijentu. QR izvoz je preuzet.",
    qrMultiExportHint: "Odaberite jedan ili više formata. Formati slika preuzimaju se kao zasebne ZIP datoteke, a PDF je spreman za štampu.",
    qrExport: "QR izvoz",
    qrExportTitle: "Izvoz QR kodova",
    qrExportDescription: "Izvezite QR oznake za sve palete koje odgovaraju trenutnoj pretrazi i filterima u tabeli.",
    qrExportPalletCount: "Palete za izvoz",
    qrExportLoading: "Učitavaju se podaci za QR izvoz, molimo sačekajte",
    qrExportModeCurrent: "Trenutna lista",
    qrExportModeRange: "QR raspon",
    qrExportModeSingle: "Jedna paleta",
    qrExportCurrentHint: "Izvozi sve palete s QR kodom koje odgovaraju trenutnoj pretrazi i filterima tabele.",
    qrExportChoosePallet: "Odaberite paletu",
    qrExportSearchPallet: "Pretražite palete...",
    exporting: "Izvoz...",
    ...
    inUse: "U upotrebi",
    forClientPickup: "Za preuzimanje",
    ...
    forRepair: "Za servis",
    markForRepair: "Označi paletu za servis",
    unmarkForRepair: "Ukloni paletu sa servisa",
    palletScanned: "Paleta skenirana",
    addPalletPhoto: "Dodaj fotografiju palete",
    skipPhoto: "Preskoči fotografiju",
    savePhoto: "Sačuvaj fotografiju",
    continueAction: "Nastavi",
    takePhoto: "Fotografiši",
    choosePhotos: "Odaberi fotografije",
    photoDatabaseLimit: "Kada pošaljete ovaj izvještaj, u bazu se čuva najviše 10 fotografija.",
    ...
    qrValueTooLong: "QR vrijednost je preduga",
    invoiceActive: "Aktivna",
    palletStatusSaveBeforeLocationError: "Status palete nije sačuvan. Pokušajte ponovo prije čuvanja lokacije dostave.",
    knowledgeAdminGlobalSettingsTitle: "Opće postavke",
    knowledgeAdminGlobalSettingsDescription: "Podesite ponašanje statusa, cijene i period tolerancije.",
    knowledgeAdminDebtTitle: "Upravljanje dugovima",
    knowledgeAdminDebtDescription: "Pregled dugova klijenata i vremena zadržavanja paleta.",
    knowledgeAdminExportTitle: "Izvoz podataka",
    knowledgeAdminExportDescription: "Izvoz izvještaja o paletama u PDF ili Excel.",
    knowledgeDriverBulkTitle: "Grupno skeniranje",
    knowledgeDriverBulkDescription: "Skenirajte više paleta odjednom radi brže isporuke.",
    knowledgeDriverClientTitle: "Odabir klijenta",
    knowledgeDriverClientDescription: "Sistem automatski nudi pretragu klijenata za status Bij de klant.",
    knowledgeDriverReturnTitle: "Voor retour",
    knowledgeDriverReturnDescription: "Kako označiti palete koje su spremne za preuzimanje.",
    knowledgeWarehouseFlowTitle: "Ulaz i izlaz",
    knowledgeWarehouseFlowDescription: "Evidencija ulaza i izlaza paleta iz magacina u BiH i NL.",
    knowledgeWarehouseDamageTitle: "Prijava oštećenja",
    knowledgeWarehouseDamageDescription: "Fotografija i opis oštećenja su obavezni prije slanja palete na servis.",
    knowledgeClientGraceTitle: "Period tolerancije",
    knowledgeClientGraceDescription: "Kako funkcioniše besplatni period od 14 dana.",
  },
} as const;
  ...
  const generatedDescriptionGroups: Array<{
    ...
    },
    {
      aliases: [
        ...
        "Driver marked pallet as Ready for Return",
        "Chauffeur heeft de bok gemarkeerd als Voor retour",
      ...
      translations: {
      en: "Driver marked pallet as Ready for Return.",
      nl: "Chauffeur heeft de bok gemarkeerd als Voor retour.",
